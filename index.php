	...
	<div class="container">
	   ...
	   <br>   
		    <div class="panel panel-info">
			  <div class="panel-heading"><center><h1>ONLINE QUIZ</h1></center></div>
			</div>
		<div class="col-sm-5">
				<br>   
				<br>   
		...
		<div class="col-sm-2"></div>
						...
						{ 
					       ...
					       ?>
							  <form role="form" method="post" action="signup_sub.php" enctype="multipart/form-data" >
								  ...
								  <div class="checkbox">
									<label><input type="checkbox"> Remember Approve</label>
								  </div>
			...
			<div class="panel panel-default">
				<div class="panel-footer">&copy;<p style="float:right">Designed & Developed by Unknown</p></div>
			</div>
		</div>
	</div>
